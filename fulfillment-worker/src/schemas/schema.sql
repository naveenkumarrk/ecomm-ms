...
CREATE TABLE warehouses (
  ...
  name TEXT,
  zone TEXT,                            -- MUM, DEL, CHN, BLR, OTHER
  pincode TEXT,
...
VALUES
  ...
  ('wh_chennai', 'Chennai Warehouse', 'CHN', '600001', 24, 16, 2, strftime('%s','now'), strftime('%s','now')),
  ('wh_bangalore', 'Bangalore Warehouse', 'BLR', '560001', 24, 16, 3, strftime('%s','now'), strftime('%s','now'));
